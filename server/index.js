...
function mergeRecipe(existing, incoming) {
  ...
  ['flag','sopFlag','qaFlag','qasFlag','sopApproval','sopStatus','sopVersion','factorySopArchived','importFlags','source','importedAt','fgItemCode','fgDescription','recipeId','tags','linkedSopRefs','processAids',
